...
powershell -Command "Reset-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Global BG Scan blocking' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Reset-NetAdapterAdvancedProperty -Name '*' -DisplayName 'GTK rekeying for WoWLAN' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Reset-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Aggressiveness' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Reset-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roam Tendency' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Reset-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Decision' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Reset-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Policy' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Reset-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Sensitivity' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Reset-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Sensitivity Level' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Enable-NetAdapterBinding -Name '*' -ComponentID ms_ndisuio -ErrorAction SilentlyContinue | Out-Null"
