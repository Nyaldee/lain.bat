...
netsh advfirewall firewall set rule group="Découverte du réseau" new enable=No >nul 2>&1
netsh advfirewall firewall set rule group="File and Printer Sharing" new enable=No >nul 2>&1
netsh advfirewall firewall set rule group="Partage de fichiers et d'imprimantes" new enable=No >nul 2>&1
...
powershell -Command "Enable-NetAdapterRss -Name '*' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterRss -Name '*' -NumberOfReceiveQueues 4 -Profile NUMAStatic -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Ad Hoc QoS Mode' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'AdaptivityPara' -DisplayValue '0' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'HLDiffForAdaptivity' -DisplayValue '0' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'L2HFForAdaptivity' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'ARP Offload for WoWLAN' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Classroom Mode' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Protocol ARP Offload' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Protocol NS Offload' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'DMA Coalescing' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'D0 Packet Coalescing' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Dynamic MIMO Power Save' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'EnableAdaptivity' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'EncapOverhead' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'FEC Mode' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Link Stat on Interface Down' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'NetworkDirect Technology' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'PTP Hardware Timestamp' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'RDMA Maximum VFs Enabled' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'RDMA VF Resource Profile' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'MDD Auto Reset VFs' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Fat Channel Intolerant' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Gigabit Master Slave Mode' -DisplayValue 'Force Master Mode' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Gigabit PHY Mode' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Global BG Scan blocking' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'GTK rekeying for WoWLAN' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Green Tx' -DisplayValue 'Off' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Human Presence Detection' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'TPC Enable' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'U-APSD support' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'IBSS Mode' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'MAC Randomization' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Maximum Number of RSS Queues' -DisplayValue '4 Queues' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'MIMO Power Save Mode' -DisplayValue 'No SMPS' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Minimum Power Consumption' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Mixed Mode Protection' -DisplayValue 'CTS-to-self Enabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Multi-Channel Concurrent' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Multimedia/Gaming Environment' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'NS Offload for WoWLAN' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Preamble Mode' -DisplayValue 'Short' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Packet Coalescing' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'QoS Packet Tagging' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'QoS Support' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Receive Side Scaling' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Aggressiveness' -DisplayValue '1. Lowest' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roam Tendency' -DisplayValue 'Lowest' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Decision' -DisplayValue 'Performance' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Policy' -DisplayValue 'Lowest' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Sensitivity' -DisplayValue '5. Lowest' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Roaming Sensitivity Level' -DisplayValue 'Low' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Sleep on WoWLAN Disconnect' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'System Idle Power Saver' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Throughput Booster' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Transmit Power' -DisplayValue '5. Highest' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Transmit power' -DisplayValue '5. Highest' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Tx Power Control' -DisplayValue 'Highest' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'VLAN ID' -DisplayValue '0' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'VHT 2.4G' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Wake on Pattern Match' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Wake Up' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Wake-Up Mode' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'XPress (TM) Technology' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetOffloadGlobalSetting -Chimney Disabled -PacketCoalescingFilter disabled -ReceiveSideScaling enabled -ReceiveSegmentCoalescing disabled -ErrorAction SilentlyContinue | Out-Null"
