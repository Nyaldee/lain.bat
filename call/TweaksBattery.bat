...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'ARP Offload for WoWLAN' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'DMA Coalescing' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Gigabit PHY Mode' -DisplayValue 'Disabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Human Presence Detection' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'Minimum Power Consumption' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'NS Offload for WoWLAN' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
...
powershell -Command "Set-NetAdapterAdvancedProperty -Name '*' -DisplayName 'System Idle Power Saver' -DisplayValue 'Enabled' -ErrorAction SilentlyContinue | Out-Null"
