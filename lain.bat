...
:: ==============================================================================
:: SOMMAIRE -- utilise Ctrl+F sur le libellé (ex: ":Option6") pour sauter direct
:: à une section ; les numéros de ligne sont indicatifs (version actuelle du fichier).
:: ==============================================================================
::   CONSTANTES ................................................... ligne 30
::   MENU PRINCIPAL (:Main_menu, dispatch des choix 1-15) ......... ligne 130
::     01 Point de restauration ................. :Option1 ........ 183
::     02 Configuration NVIDIA .................. :NVIDIA_menu .... 581
::     03 Configuration globale du système ...... :Option3 ........ 188
::     04 Paramètres réseau ...................... :Option4 ........ 287
::     05 Plan d'alimentation .................... :Option5 ........ 303
::     06 Runtimes & Frameworks (VC++, .NET...) .. :Option6 ........ 354
::     07 Timer Resolution Service ............... :Option7 ........ 407
::     08 Désactiver les services inutiles ....... :Services_menu .. 661
::     09 Désactiver SmartScreen / bloquer Edge .. :Option9 ........ 433
::     10 Désactiver Bluetooth .................... :Option10 ....... 459
::     11 Désactiver Wifi .......................... :Option11 ....... 488
::     12 Bloquer IPs espionnage / tracking ....... :Option12 ....... 513
::     13 Désactiver Windows Update ............... :Option13 ....... 546
::     14 Divers ................................... :Misc_menu ...... 719
::     15 Vérifier les paramètres Windows ......... :Check_menu ..... 879
::   SOUS-ROUTINES (AskChoice, FetchOnly, Ansi, AnselSet...) ...... ligne 959
:: ==============================================================================
...
set "URL_HOSTS_LIST=%CALL_URL%/BlockedHosts.txt"
...
if errorlevel 1 goto Main_menu
:: Table URL|nom local|arguments silencieux -- une entree par redistribuable x86/x64.
for %%p in (
    "https://download.microsoft.com/download/8/B/4/8B42259F-5D70-43F4-AC2E-4B208FD8D66A/vcredist_x86.EXE|vcredist2005_x86.exe|/q"
    "https://download.microsoft.com/download/8/B/4/8B42259F-5D70-43F4-AC2E-4B208FD8D66A/vcredist_x64.EXE|vcredist2005_x64.exe|/q"
    "https://download.microsoft.com/download/5/D/8/5D8C65CB-C849-4025-8E95-C3966CAFD8AE/vcredist_x86.exe|vcredist2008_x86.exe|/quiet /norestart"
    "https://download.microsoft.com/download/5/D/8/5D8C65CB-C849-4025-8E95-C3966CAFD8AE/vcredist_x64.exe|vcredist2008_x64.exe|/quiet /norestart"
    "https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x86.exe|vcredist2010_x86.exe|/quiet /norestart"
    "https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x64.exe|vcredist2010_x64.exe|/quiet /norestart"
    "https://download.microsoft.com/download/1/6/B/16B06F60-3B20-4FF2-B699-5E9B7962F9AE/VSU_4/vcredist_x86.exe|vcredist2012_x86.exe|/quiet /norestart"
    "https://download.microsoft.com/download/1/6/B/16B06F60-3B20-4FF2-B699-5E9B7962F9AE/VSU_4/vcredist_x64.exe|vcredist2012_x64.exe|/quiet /norestart"
    "https://download.microsoft.com/download/2/e/6/2e61cfa4-993b-4dd4-91da-3737cd5cd6e3/vcredist_x86.exe|vcredist2013_x86.exe|/quiet /norestart"
    "https://download.microsoft.com/download/2/e/6/2e61cfa4-993b-4dd4-91da-3737cd5cd6e3/vcredist_x64.exe|vcredist2013_x64.exe|/quiet /norestart"
    "https://aka.ms/vs/17/release/vc_redist.x86.exe|vcredist2022_x86.exe|/quiet /norestart"
    "https://aka.ms/vs/17/release/vc_redist.x64.exe|vcredist2022_x64.exe|/quiet /norestart"
) do (
    for /f "tokens=1,2,3 delims=|" %%u in (%%p) do (
        call :FetchOnly "%%u" "%%v" "%TEMP_DIR%"
        if errorlevel 1 goto Main_menu
        start /wait "" "%TEMP_DIR%\%%v" %%w
    )
)
